...
%% Part two: compute connectivity between all pairs of channels – this will create a channel x channel matrix of connectivity that you can also then visualize
