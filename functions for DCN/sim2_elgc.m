...
twin = 400;
tfg = GPDC_tf3(data(1,:,:) ,data(2,:,:), EEG.times,times2save, freqs, srate, morder,twin);
...
subplot(235);contourf(times2save, freqs, squeeze(tfg(1,2,:,:)), 40, 'linecolor','non'); colorbar
set(gca,'clim',[0 0.2])
set(gca, 'fontsize', 30)
...
subplot(236);contourf(times2save, freqs, squeeze(tfg(1,1,:,:)), 40, 'linecolor','non'); cl = colorbar;
set(gca,'clim',[0 0.2])
